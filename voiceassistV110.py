...
import pywhatkit as kt  #Helps in peforming generic tasks on googgle chrome


 
print("\nFew Examples...\n")  
print("Play 'Latest Songs'")
print("Open 'Facebook'")
print("Shahrukh Khan Wikipedia")
print("Search'Current Affairs'")
...
def intake():
        ...
        with sr.Microphone() as source: #The audio input of the user is taken from Microphone as naming as source
            ...
            try:  #We are asking the machine ti try these, because even after the machine throws an error, the code must not stop
                ...
                speak("You can try saying, open Gaana or Play Bollywood Songs!")
                query = intake().lower()  #The query will be taken in lower case
                return None  #It returns the value of the query 
...
if __name__ == "__main__":   #main function
    while True:  #The below statements will be looping if the queries are found in the below statements
        query = intake().lower()
        if "exit" in query:  #The programe will exit when the user says "no thanks"
            print("Thank you! I hope I was helpful :)")
            speak("Thank you! I hope I was helpful")
            exit()
        if "play" in query:
            speak("Enjoy your content! Bye!")
            kt.playonyt(query)
            exit()
            ...
            speak(results)
            time.sleep(3)  #After performing the task, will be silent for 6 secs
            ...
            query = pyjokes.get_joke(language="en", category="neutral")
            print(query)
            speak(query)
            time.sleep(5)
            speak("Is there anything else you want me to do?")
        ...
        #     exit()
            ...
            speak("This is the best I found")
            kt.search(query)
            time.sleep(3)
            speak("Is there anything else you want me to do?")
        elif "who is ":
